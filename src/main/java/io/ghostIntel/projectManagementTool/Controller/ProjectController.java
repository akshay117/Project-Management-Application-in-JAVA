...
public class ProjectController {
    ...
    @Autowired
    private io.ghostIntel.projectManagementTool.Domain.Services.ProjectService projectService;

    @Autowired
    private io.ghostIntel.projectManagementTool.Domain.Services.MapValidationErrorService mapValidationErrorService;
